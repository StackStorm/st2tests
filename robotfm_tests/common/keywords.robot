...
SETUP:Copy and Load Examples Pack
    ...
    ${result}=    Run Process     st2-register-content  \-\-register\-pack  /opt/stackstorm/packs/examples  \-\-register\-all  \-\-register\-no\-fail\-on\-failure  2>  /dev/null  stderr=STDOUT  shell=True
    Log To Console    \nSETUP:\n
